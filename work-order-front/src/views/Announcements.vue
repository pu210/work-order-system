    ...
    <div class="announce-list">
      ...
      >
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start mb-2">
            ...
            <div v-if="authStore.hasRole('ADMIN')" class="d-flex gap-2">
              ...
              <button
                ...
                @click="deleteAnn(a.announcementId)"
              >
                刪除
              </button>
            </div>
          ...
          <!-- 公告內容：Vue 3 {{ }} 自動安全渲染文字 -->
          <p
            class="card-text text-secondary mt-2 mb-3"
      ...
      <div
        ...
        class="text-center py-5 text-muted card shadow-sm"
      >
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              <label class="form-label fw-bold small"
                >公告標題 <span class="text-danger">*</span></label
              >
              <input
                v-model="form.title"
                type="text"
            ...
            <div class="mb-3">
              <label class="form-label fw-bold small"
                >公告內容 <span class="text-danger">*</span></label
              >
              <textarea
