        ...
        <div class="task-panel">
          ...
          >
            ...
            <div class="todo-info-list">
              <p><i class="bi bi-tools me-1"></i>負責工程師：{{ ticket.assignedHandlerName || authStore.name || '—' }}</p>
              <p><i class="bi bi-person-badge me-1"></i>負責管理員：{{ ticket.adminName || '尚未指定' }}</p>
              <p><i class="bi bi-person me-1"></i>報修人：{{ ticket.creatorName || '—' }}</p>
          ...
          >
            ...
            <div class="order-card-body">
              <div class="order-main min-width-0">
                ...
                <p class="mb-0">
                  負責工程師：{{ ticket.assignedHandlerName || authStore.name || '—' }}
                  <span class="mx-1">｜</span>
