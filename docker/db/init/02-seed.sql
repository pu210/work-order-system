...
VALUES            ('admin', '$2b$10$ijvnB3Dlv8pi3..wbmByJOfhWOwkcn6YlEHUDshVrbbPa2Yd5IXwG', 0, N'系統管理員', 'admin@company.com', '0900000000', 1),
...
VALUES                        (1, N'電力設備', 2, 1, '2026-01-05 09:00:00', '2026-01-05 09:00:00', N'高'),
...
INSERT  INTO sub_categories (
    ...
    category_id,
    name,
    override_priority_id,
    status,
    created_time,
    updated_time,
    override_priority_name
)
VALUES                     (1, 1, N'電燈故障', NULL, 1, '2026-01-06 09:00:00', '2026-01-06 09:00:00', NULL),
...
VALUES                 (1, 1, '2026-01-01 08:00:00'), -- admin -> ADMIN
...
INSERT  INTO dbo.repair_targets (
    target_id,
    target_no,
    name,
    model
)
VALUES                         (1, 'T-0001', N'分離式冷氣', N'Panasonic CS-A28FA2'),
...
VALUES                  (1, 'WO-2026-0001', N'辦公室日光燈不亮', 1, 2, N'A棟3樓辦公區', '0912345001', N'靠窗第二排燈管閃爍後熄滅', '2026-01-11 09:00:00', 'PENDING_REVIEW', '2026-01-10 09:00:00', 7, NULL, 0, 0, NULL, NULL),
...
VALUES                             (1, 1, N'燈管閃爍.jpg', NULL, 'image/jpeg', 204800, '2026-01-10 09:02:00', 7),
...
-- ----------------------------------------------------------------------------
INSERT  INTO repair_ticket_edit_session (
    ticket_id,
    user_id,
    session_token,
    start_time,
...
VALUES                                 (3, 2, N'sess-tok-a1b2c3d4', '2026-08-20 10:00:00', '2026-08-20 10:12:00'),
...
VALUES                            (1, 3, 'PENDING_REVIEW', '2026-01-15 09:00:00', 9, 'CREATE', NULL),
...
VALUES                      (1, 9, 3, N'請問大概什麼時候會有人來處理？', '2026-01-15 09:30:00', 'COMMENT'),
...
VALUES                    (1, 3, 'IN_PROGRESS', N'工單已指派', N'您的工單 WO-2026-0003 已指派給維修人員處理', 1, 1, 9, 1, '2026-01-15 11:00:00'),
...
VALUES                           (1, N'系統維護通知', N'系統將於本週六凌晨 2:00-4:00 進行例行維護，期間暫停服務。', 'MAINTENANCE', 1, '2026-02-01 00:00:00', '2026-02-08 00:00:00', 1, '2026-01-28 09:00:00'),
...
VALUES                      (1, 7, N'系統操作問題', N'請問報修單送出後可以自行修改內容嗎？', '2026-02-10 09:00:00'),
