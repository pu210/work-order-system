...
public class Announcement {
    ...
    private Integer announcementId; // 公告流水號（主鍵，自增）
    ...
    private LocalDateTime endTime; // 公告下架時間（過期自動隱藏）

    @Column(name = "created_by", nullable = false)
    private Integer createdBy; // 發布者 ID（管理者 ID）

    @CreationTimestamp
    @Column(name = "created_time", updatable = false)
    private LocalDateTime createdTime; // 建立時間 (預設 GETDATE())
}
